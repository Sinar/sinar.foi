...
#
#  $ bin/test -s sinar.foi -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src sinar.foi.testing.SINAR_FOI_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/sinar/foi/tests/robot/test_example.robot
#
